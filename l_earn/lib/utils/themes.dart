...
static ThemeData myAppTheme = ThemeData(
    ...
    elevatedButtonTheme: const ElevatedButtonThemeData(
        style: ButtonStyle(
            ...
            backgroundColor: MaterialStatePropertyAll(AppColor.mainColorBlack),
    ...
    appBarTheme: const AppBarTheme(
        ...
        iconTheme: IconThemeData(size: 24, weight: 1, color: AppColor.textColor),
    ...
    inputDecorationTheme: InputDecorationTheme(
        ...
        border: OutlineInputBorder(
            borderSide: BorderSide(color: AppColor.textfieldEnabledBoderColor),
            borderRadius: BorderRadius.circular(8)),
        //* for focused border
        focusedBorder: OutlineInputBorder(
            borderSide: BorderSide(color: AppColor.textfieldFocusedBoderColor),
            borderRadius: BorderRadius.circular(8)),
